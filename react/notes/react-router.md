...
### 4-2. `useNavigate()` 훅 사용 (프로그래밍 방식으로 이동)
...
## 6. 쿼리 스트링 (`useSearchParams`)

### 6-1. URL 쿼리 스트링 사용 (`?key=value`)
```jsx
...
## 7. 중첩 라우트 (Nested Routes)

### 7-1. `Outlet`을 사용한 중첩 라우팅
```jsx
...
- [MDN - URL 및 경로](https://developer.mozilla.org/ko/docs/Web/API/URL)

---

🚀 **React Router를 익혔다면, 이제 데이터 Fetching을 배워봅시다!**  
다음 개념: [데이터 Fetching](./fetching-data.md) →
