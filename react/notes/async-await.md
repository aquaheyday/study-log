...
### 3-2. `useEffect`에서 `async/await` 사용
```jsx
import { useEffect, useState } from "react";
...
- [JavaScript 비동기 처리 (MDN)](https://developer.mozilla.org/ko/docs/Learn/JavaScript/Asynchronous)

---

🚀 **React 비동기 처리 개념을 익혔다면, 이제 성능 최적화를 배워봅시다!**  
다음 개념: [성능 최적화](./performance.md) →
